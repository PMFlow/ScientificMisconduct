...
%%   deterministic algorithm, i.e. a FD scheme !
...
%% Initial conditions
load IC_Richy_sat_101; % scenario-1 % IC_Richy_sat_101_new2 % 
p=c;
L=2;
pinit=p;
thtinit=tht;
...
legend(strvect); legend('boxoff');  xlim([0 500]); ylim([Tolerance inf]); 
figure(4);
