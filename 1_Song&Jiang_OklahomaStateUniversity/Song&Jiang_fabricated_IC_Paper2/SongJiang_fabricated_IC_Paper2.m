%% see red comment on page 5(823) of Paper2_commented.pdf:
%% Figs. 1 and 2 in [Song & Jiang, 2023, https://checlams.github.io/assets/pdf/paper/songescape2023.pdf]
%% are in fact FABRICATED Initial Conditions for the benchmark [List&Radu, 2016], as shown at lines 38-40 below
...
% c0(J,I)=c0(J,I)-0.1; % when uncommented ---> Figs. 1a and 2a
